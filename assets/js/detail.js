...
fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}?append_to_response=casts%2Cvideos%2Cimages%2Creleases&api_key=${api_key}`, function (movie) {
