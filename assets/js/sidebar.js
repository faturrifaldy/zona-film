...
export function sidebar() {
  ...
  sidebarInner.innerHTML = `
    ...
    <div class="sidebar-list">
        ...
        <a href="./movie-list.html" menu-close class="sidebar-link" onclick="getMovieList('with_original_language=id','Indonesian')">Indonesia</a>
    </div>

    <div class="sidebar-footer">
        <p class="copyright">Copyright 2025</p>
        <p class="copyright">Faturrahman Rifaldy_F52121042</p>
